...
void ACryptRaiderCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ACryptRaiderCharacter::OnFire);

	// Enable touchscreen input
	EnableTouchscreenMovement(PlayerInputComponent);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACryptRaiderCharacter::OnResetVR);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ACryptRaiderCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ACryptRaiderCharacter::LookUpAtRate);
}

void ACryptRaiderCharacter::OnFire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<ACryptRaiderProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void ACryptRaiderCharacter::OnResetVR()
{
